...
OLLAMA_THINK = get_bool_env("OLLAMA_THINK", False)
OLLAMA_KEEP_ALIVE = os.getenv("OLLAMA_KEEP_ALIVE", "15m").strip() or "15m"
OLLAMA_NUM_PREDICT = get_int_env("OLLAMA_NUM_PREDICT", 384)
...
RAG_SEARCH_TOP_K = max(1, int(os.getenv("RAG_SEARCH_TOP_K", "20")))
...
SYSTEM_HEALTH_OLLAMA_TIMEOUT_SECONDS = max(
    1,
    get_int_env("SYSTEM_HEALTH_OLLAMA_TIMEOUT_SECONDS", 5),
)
SYSTEM_HEALTH_CHECKPOINT_STALE_MINUTES = max(
    1,
    get_int_env("SYSTEM_HEALTH_CHECKPOINT_STALE_MINUTES", 1440),
)
SYSTEM_HEALTH_CHECKPOINT_RUNNING_STALE_MINUTES = max(
    1,
    get_int_env("SYSTEM_HEALTH_CHECKPOINT_RUNNING_STALE_MINUTES", 120),
)
